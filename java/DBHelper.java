...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table Customer " + "(id integer primary key  ,Email text , Contact text,Username text)");
    ...
    public void addMsg(String ms){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("Email",ms);

        db.insert("Customer",null,contentValues);
        db.close();
    }
    public void addRow(String email,String uname,String contact){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
